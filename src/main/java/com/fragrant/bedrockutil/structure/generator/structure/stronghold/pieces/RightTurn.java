...
public class RightTurn extends StrongholdPiece { //Called SHRightTurn in bedrock

	public RightTurn(int pieceId, ChunkRandom rand, BoundingBox boundingBox, Direction facing) {
		super(pieceId);
		this.facing = facing;
	...
	public static RightTurn createPiece(List<StrongholdPiece> pieces, ChunkRandom rand, int x, int y, int z, Direction facing, int pieceId) {
		BoundingBox box = BoundingBox.rotated(x, y, z, -1, -1, 0, 5, 5, 5, facing.getRotation());
		return StrongholdPiece.isHighEnough(box) && StrongholdPiece.findCollisionPiece(pieces, box) == null ? new RightTurn(pieceId, rand, box, facing) : null;
	}
